...
ZILLOW_QUERY_PARAMS = {
    "searchQueryState": '{"pagination":{"currentPage":1},"usersSearchTerm":"Thompsons Station","mapBounds":{'
                        '"west":-87.1425982001953,"east":-86.66881279980467,"south":35.646757343441735,'
                        '"north":35.99806935769734},'
                        '"isMapVisible":false,"filterState":{"doz":{"value":"24m"},'
...
gen_params = {'searchQueryState': '{"pagination": {"currentPage": 1}, "mapBounds": {"west": 42.3878947, "east": '
                                  '42.3892287, "north": -71.1198358, "south": -71.1187467}, "MapVisible": false, '
                                  '"sort": {"value": "globalrelevance"}, "isListVisible": true, "filterState": {'
                                  '"doz": {"value": "24m"}, "pmf": {"value": false}, "fore": {"value": false}, '
                                  '"ah": {"value": true}, "auc": {"value": false}, "nc": {"value": false}, '
                                  '"rs": {"value": true}, "fsbo": {"value": false}, "cmsn": {"value": false}, '
                                  '"pf": {"value": false}, "fsba": {"value": false}, "sort": {"value": '
                                  '"globalrelevanceex"}}}'}
